pipeline {
     environment {
       ...
       APP_NAME = "fadaz"
       STG_API_ENDPOINT = "192.168.56.30:1993"
       STG_APP_ENDPOINT = "192.168.56.30:80"
       PROD_API_ENDPOINT = "192.168.56.30:1993"
       PROD_APP_ENDPOINT = "192.168.56.30:80"
       INTERNAL_PORT = "5000"
     ...
     stage ('Login and Push Image on docker hub') {
          agent any
        environment {
           DOCKERHUB_PASSWORD  = credentials('dockerhub_fadaaz')
        }            
          steps {
             script {
               sh '''
